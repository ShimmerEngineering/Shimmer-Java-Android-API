 ...
 *
 */
public class MultitouchPlot9DoF extends XYPlot implements OnTouchListener
{
	...
	public MultitouchPlot9DoF(Context context, String title)
	{
		super(context, title);
		initTouchHandling();
	}

	public MultitouchPlot9DoF(Context context, AttributeSet attributes)
	{
		super(context, attributes);
		initTouchHandling();
	}

	public MultitouchPlot9DoF(Context context, AttributeSet attrs, int defStyle)
	{
