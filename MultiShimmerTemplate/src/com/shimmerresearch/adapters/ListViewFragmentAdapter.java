...
// 						List<SelectedSensors> listEnableSensors = createListOfEnableSensor(enabledSensors);						
						dF.enableSensorListView.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE);
 						...
 						for (int i=0;i<dF.compatibleSensors.length;i++){
 							if(dF.mService.getShimmerVersion(dF.deviceBluetoothAddresses[currentPosition])==Shimmer.SHIMMER_3 && dF.compatibleSensors[i].equals("ECG")){
 							...
 							else if(dF.mService.getShimmerVersion(dF.deviceBluetoothAddresses[currentPosition])==Shimmer.SHIMMER_3 && dF.compatibleSensors[i].equals("EMG")){
 							...
 							else if(dF.mService.getShimmerVersion(dF.deviceBluetoothAddresses[currentPosition])==Shimmer.SHIMMER_3 && dF.compatibleSensors[i].equals("Test signal")){
