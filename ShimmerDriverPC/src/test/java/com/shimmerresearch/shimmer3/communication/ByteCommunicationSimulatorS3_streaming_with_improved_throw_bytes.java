...
public class ByteCommunicationSimulatorS3_streaming_with_improved_throw_bytes extends ByteCommunicationSimulatorS3{
	public static int CONTIGUOUS_TIMESTAMP_TICKS_LIMIT = (10*32768);
	public ByteCommunicationSimulatorS3_streaming_with_improved_throw_bytes(String address) {
		super(address);
