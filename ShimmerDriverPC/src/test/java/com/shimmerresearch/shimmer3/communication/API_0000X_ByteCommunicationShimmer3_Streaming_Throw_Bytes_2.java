...
public class API_0000X_ByteCommunicationShimmer3_Streaming_Throw_Bytes_2 extends BasicProcessWithCallBack{
	ShimmerPC mDevice;
	...
	@Before
    public void setUp() {
		mByteCommunicationSimulatorS3 = new ByteCommunicationSimulatorS3_streaming_with_improved_throw_bytes_2("COM99");
    ...
    public void test001_testStreaming() {
		...
		try {
			...
			if(mListOJC.size()!=2) {//two is expected as the bytes thrown are before the first packet
	    		assert(false);
			}
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
